...
- **Versioning** is driven by the git tag. CI automatically syncs the tag version (e.g. `v0.1.1`) into `Cargo.toml` and `android/gradle.properties` before building. No manual version file edits needed — just push the tag.
